...
import { Showcase, TEST_KEY_NAMES } from "@/.storybook/common";
...
} satisfies Meta<typeof HistoryPageContent>;
...
export const AllStates: Story = {
  ...
  render: () => (
    <Showcase
      items={[
        { label: "With requests (mixed statuses)", children: <HistoryPageContent requests={requests} /> },
        { label: "Empty", children: <HistoryPageContent requests={[]} /> },
      ]}
    />
  ),
};
