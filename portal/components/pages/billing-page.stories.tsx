    ...
    <Showcase
      items={[
        ...
        },
        {
          ...
          children: <BillingPageContent {...defaults} freeUsagePercent={100} processedKB={220000} freeRemainingKB={0} freeTotalKB={50000} estimatedCost={5.10} pricePerUnit={0.003} invoices={invoices} />,
        },
        {
